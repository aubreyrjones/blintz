class BlintzParser < Dhaka::CompiledParser
  ...
  at_state(0) {
    ...
    for_symbols("global_declaration") { shift_to 107 }
  ...
  at_state(10) {
    ...
    for_symbols("formals_list") { shift_to 98 }
    for_symbols("formal_param") { shift_to 106 }
    for_symbols("NAME_LITERAL") { shift_to 101 }
  ...
  at_state(12) {
    ...
    for_symbols("expr") { shift_to 40 }
    for_symbols("return") { shift_to 80 }
    for_symbols("var") { shift_to 84 }
    for_symbols("DECIMAL_LITERAL") { shift_to 60 }
    for_symbols("HEX_LITERAL") { shift_to 61 }
    for_symbols("NAME_LITERAL") { shift_to 62 }
  ...
  at_state(14) {
    ...
    for_symbols("statement") { shift_to 97 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("if") { shift_to 20 }
    for_symbols("while") { shift_to 30 }
  ...
  at_state(22) {
    ...
    for_symbols("LOG_AND") { shift_to 52 }
    for_symbols("LOG_OR") { shift_to 54 }
    for_symbols("BIT_AND") { shift_to 56 }
    for_symbols("BIT_OR") { shift_to 58 }
  }
  ...
  at_state(24) {
    ...
    for_symbols("elsif_clause") { shift_to 96 }
    for_symbols("elsif") { shift_to 91 }
  ...
  at_state(64) {
    for_symbols("*", "/", "-", "+", "LOG_AND", "LOG_OR", "BIT_AND", "BIT_OR", ";", "=", ")", "]", "@") { reduce_with "function_call" }
  }
  ...
  at_state(70) {
    for_symbols("NAME_LITERAL") { shift_to 71 }
  }
  ...
  at_state(84) {
    for_symbols("var_declaration") { shift_to 85 }
    for_symbols("NAME_LITERAL") { shift_to 87 }
  ...
  at_state(89) {
    for_symbols("NAME_LITERAL") { shift_to 90 }
  }
  ...
  at_state(91) {
    for_symbols("(") { shift_to 92 }
  }

  at_state(92) {
    for_symbols("expr") { shift_to 93 }
    for_symbols("DECIMAL_LITERAL") { shift_to 60 }
    for_symbols("HEX_LITERAL") { shift_to 61 }
    for_symbols("NAME_LITERAL") { shift_to 62 }
    for_symbols("@") { shift_to 65 }
  ...
  at_state(94) {
    for_symbols("statement") { shift_to 95 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("if") { shift_to 20 }
    for_symbols("while") { shift_to 30 }
  ...
  at_state(98) {
    for_symbols(",") { shift_to 99 }
    for_symbols(")") { reduce_with "formals_declared" }
  }

  at_state(99) {
    for_symbols("formal_param") { shift_to 100 }
    for_symbols("NAME_LITERAL") { shift_to 101 }
    for_symbols("@") { shift_to 102 }
  }
  ...
  at_state(103) {
    for_symbols("as") { shift_to 104 }
    for_symbols(")", ",") { reduce_with "array_param" }
  }

  at_state(104) {
    for_symbols("TYPE_LITERAL") { shift_to 105 }
  }
