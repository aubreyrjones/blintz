class BlintzParser < Dhaka::CompiledParser
  ...
  at_state(0) {
    ...
    for_symbols("global_declaration") { shift_to 134 }
  ...
  at_state(10) {
    ...
    for_symbols("formals_list") { shift_to 125 }
    for_symbols("formal_param") { shift_to 133 }
    for_symbols("NAME_LITERAL") { shift_to 128 }
  ...
  at_state(12) {
    ...
    for_symbols("next") { shift_to 20 }
    for_symbols("if") { shift_to 22 }
    for_symbols("while") { shift_to 31 }
    for_symbols("assignment_indirect_p") { shift_to 39 }
    for_symbols("return") { shift_to 41 }
    for_symbols("var") { shift_to 92 }
    for_symbols("NAME_LITERAL") { shift_to 99 }
    for_symbols("@") { shift_to 102 }
  ...
  at_state(14) {
    ...
    for_symbols("statement") { shift_to 124 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("next") { shift_to 20 }
    for_symbols("if") { shift_to 22 }
  ...
  at_state(15) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "elsif", "else", "_End_", "import", "def") { reduce_with "null_statement" }
  }
  ...
  at_state(17) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "elsif", "else", "_End_", "import", "def") { reduce_with "compound_statement" }
  }

  at_state(18) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[") { reduce_with "multiple_items" }
  }

  at_state(19) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "elsif", "else", "_End_", "import", "def") { reduce_with "simple_statement" }
  }
  ...
  at_state(21) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "elsif", "else", "_End_", "import", "def") { reduce_with "next_statement" }
  }
  ...
  at_state(23) {
    ...
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
    for_symbols("NAME_LITERAL") { shift_to 69 }
    for_symbols("@") { shift_to 72 }
    for_symbols("#") { shift_to 82 }
  ...
  at_state(24) {
    ...
    for_symbols("EQUALS") { shift_to 45 }
    for_symbols("<") { shift_to 47 }
    for_symbols(">") { shift_to 49 }
    for_symbols("*") { shift_to 51 }
    for_symbols("/") { shift_to 53 }
    for_symbols("-") { shift_to 55 }
    for_symbols("+") { shift_to 57 }
    for_symbols("LOG_AND") { shift_to 59 }
    for_symbols("LOG_OR") { shift_to 61 }
    for_symbols("BIT_AND") { shift_to 63 }
    for_symbols("BIT_OR") { shift_to 65 }
  }
  ...
  at_state(26) {
    for_symbols("elsif_list") { shift_to 27 }
    for_symbols("elsif_rec_list") { shift_to 116 }
    for_symbols("elsif_clause") { shift_to 123 }
    for_symbols("elsif") { shift_to 118 }
    for_symbols("else", "next", "}", "{", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "_End_", "import", "def") { reduce_with "no_elsif" }
  }

  at_state(27) {
    for_symbols("else_clause") { shift_to 28 }
    for_symbols("else") { shift_to 29 }
    for_symbols("next", "elsif", "}", "{", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "_End_", "import", "def") { reduce_with "else_absent" }
  }
  ...
  at_state(34) {
    for_symbols("statement") { shift_to 35 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("next") { shift_to 20 }
    for_symbols("if") { shift_to 22 }
  ...
  at_state(37) {
    for_symbols("statement") { shift_to 38 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("next") { shift_to 20 }
    for_symbols("if") { shift_to 22 }
  ...
  at_state(72) {
    for_symbols("NAME_LITERAL") { shift_to 73 }
  }

  at_state(73) {
    for_symbols("[") { shift_to 74 }
    for_symbols("EQUALS", "<", ">", "*", "/", "-", "+", "LOG_AND", "LOG_OR", "BIT_AND", "BIT_OR", "]", ";", ")", "@") { reduce_with "array_name" }
  }

  at_state(74) {
    for_symbols("index_expr") { shift_to 75 }
    for_symbols(":") { shift_to 77 }
    for_symbols("expr") { shift_to 81 }
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
    for_symbols("NAME_LITERAL") { shift_to 69 }
    for_symbols("@") { shift_to 72 }
  ...
  at_state(77) {
    for_symbols("NAME_LITERAL") { shift_to 78 }
  }

  at_state(78) {
    for_symbols("(") { shift_to 79 }
  ...
  at_state(82) {
    for_symbols("NAME_LITERAL") { shift_to 83 }
  }
  ...
  at_state(92) {
    for_symbols("var_declaration") { shift_to 93 }
    for_symbols("NAME_LITERAL") { shift_to 95 }
    for_symbols("expr") { shift_to 96 }
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
    for_symbols("@") { shift_to 72 }
    for_symbols("#") { shift_to 82 }
  ...
  at_state(97) {
    for_symbols("NAME_LITERAL") { shift_to 98 }
  }
  ...
  at_state(99) {
    for_symbols("=") { shift_to 100 }
  }

  at_state(100) {
    for_symbols("expr") { shift_to 101 }
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
    for_symbols("NAME_LITERAL") { shift_to 69 }
    for_symbols("@") { shift_to 72 }
  ...
  at_state(102) {
    for_symbols("NAME_LITERAL") { shift_to 103 }
  }

  at_state(103) {
    for_symbols("=") { shift_to 104 }
    for_symbols("[") { shift_to 106 }
  }

  at_state(104) {
    for_symbols("expr") { shift_to 105 }
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
    for_symbols("NAME_LITERAL") { shift_to 69 }
    for_symbols("@") { shift_to 72 }
  ...
  at_state(106) {
    for_symbols("index_expr") { shift_to 107 }
    for_symbols(":") { shift_to 77 }
    for_symbols("expr") { shift_to 81 }
    for_symbols("DECIMAL_LITERAL") { shift_to 67 }
    for_symbols("HEX_LITERAL") { shift_to 68 }
  ...
  at_state(116) {
    for_symbols("elsif_clause") { shift_to 117 }
    for_symbols("elsif") { shift_to 118 }
    for_symbols("else", "next", "}", "{", "if", "while", "return", "var", "NAME_LITERAL", "@", "[", "_End_", "import", "def") { reduce_with "elsif_present" }
  }
  ...
  at_state(121) {
    for_symbols("statement") { shift_to 122 }
    for_symbols("{") { shift_to 14 }
    for_symbols("primary_statement") { shift_to 19 }
    for_symbols("next") { shift_to 20 }
    for_symbols("if") { shift_to 22 }
  ...
  at_state(124) {
    for_symbols("}", "{", "next", "if", "while", "return", "var", "NAME_LITERAL", "@", "[") { reduce_with "statement_item" }
  }
  ...
  at_state(126) {
    for_symbols("formal_param") { shift_to 127 }
    for_symbols("NAME_LITERAL") { shift_to 128 }
    for_symbols("@") { shift_to 129 }
  }
  ...
  at_state(129) {
    for_symbols("NAME_LITERAL") { shift_to 130 }
  }

  at_state(130) {
    for_symbols("as") { shift_to 131 }
    for_symbols(")", ",") { reduce_with "array_param" }
  }

  at_state(131) {
    for_symbols("TYPE_LITERAL") { shift_to 132 }
  }
